...
@Component({
  ...
  template: `
    <mat-toolbar color="accent" fxLayoutGap="8px">
      ...
      <button mat-mini-fab routerLink="/inventory" matTooltip="Inventory" aria-label="Inventory" color="primary">
        <mat-icon>list</mat-icon>
      </button>
      <button mat-mini-fab routerLink="/pos" matTooltip="POS" aria-label="POS" color="primary">
